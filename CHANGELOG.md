...
- **InfoPanel slide carousel offset**: Simplified the slide container styling to a standard `width: 100%` width with viewport-relative translations (`-100%`, `-200%`), fixing an alignment rounding issue that shifted the inner slides and cut off the left edge of the content.
