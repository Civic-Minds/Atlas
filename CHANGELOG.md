...
- **Agency slug search** (e.g. `ttc`): Agency result appears first; routes that only matched via agency slug are hidden. Route lists cap at 30 with a refine-search hint when truncated.
