...
### Added
- **18 new agencies**: TransLink (Vancouver), BC Transit Fraser Valley, BC Transit Victoria, BC Transit Kelowna, RTC (Québec City), Sarnia Transit, Blue Water Area Transit (Port Huron), DDOT, SMART, Detroit People Mover, QLine, TheRide (Ann Arbor), GCRTA (Cleveland), TARTA (Toledo), Calgary Transit, Edmonton Transit (ETS), Winnipeg Transit, Halifax Transit. Total: 58 agencies across Ontario, Quebec, British Columbia, Alberta, Manitoba, Nova Scotia, New York, Michigan, and Ohio. Calgary/Edmonton/Winnipeg use direct city feed URLs (MDB copies were expired).
