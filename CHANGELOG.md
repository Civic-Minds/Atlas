...
- **Map attribution**: Custom bottom-left pill uses same `text-[10px]` label styling as routes/coverage badges (replaces MapLibre control); loading spinner co-located with stats pills bottom-right.
