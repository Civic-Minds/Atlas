...
- **Map attribution**: Bottom-left pill mirrors “39 routes” typography (`text-xs` primary + `text-[10px]` label); loading spinner co-located with stats pills bottom-right.
