...
- **Continent specialty agencies**: Added JFK AirTrain, Staten Island Ferry, NYC Ferry, Roosevelt Island Tramway, Guadalajara Mi Transporte, Cheyenne Transit Program, Rapid Transit System (Rapid City), and Sioux City Transit — NYC water/airport specialties, first Mexico coverage, first Wyoming agency, and Iowa/Nebraska border. Config only.
