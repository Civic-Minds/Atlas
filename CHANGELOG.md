...
### Fixed
- **History: loading state for agency suggestions**: Added a loading state when loading history configuration data from R2, preventing a flash of "No agencies match" while the request is in flight.
