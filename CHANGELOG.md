...
- **PMTiles + MapLibre GL benchmarking (AI-145)**: Benchmarked sizes of static agency routes, stops, and corridors GeoJSON datasets hosted on R2, revealing a total payload size of 119.4 MB (up to 8.8 MB for single agencies like TransLink/TTC). Documented Leaflet scale limitations and drew up an implementation blueprint for a WebGL vector-tile migration utilizing PMTiles and MapLibre GL.
