...
### Fixed
- **Time scrubber design consistency**: The History time scrubber now uses the app's FLOATING_CARD surface, properly styled custom range (thin track + bordered thumb matching accent vars), consistent text sizes (8-9px with tracking), and uppercase header to blend with other panels (was plain native range + tiny labels).
