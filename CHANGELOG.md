...
- **Right-click the map to copy a URL pointing at that exact spot**: useful for reporting a precise location (e.g. a rendering bug) without having to recenter the map there first.
