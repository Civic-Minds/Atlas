...
const reviewed = {
  ...
  lethbridge: {
    status: 'map_unavailable', mapCandidates: [{ label: 'Lethbridge Transit Network in Transportation Master Plan', url: 'https://www.lethbridge.ca/media/t2wnioeg/tmp_final_fulltechnical_oct25_stamped.pdf', sourceType: 'planning_map' }], mapPageOrSection: 'page 136, planning map', exactMapWording: 'Peak Frequency 30–40 min; Peak Frequency 60 min', evidenceNotes: 'An official planning document contains a transit network map, but no current rider-facing system map was verified. The planning map is retained as a lead and excluded from system-map evidence.'
  },
  'campbell-river': {
    status: 'no_definition_on_map', mapCandidates: [{ label: 'Campbell River Rider Guide / system map', url: 'https://www.bctransit.com/campbell-river/wp-content/uploads/sites/8/2025/09/12586_CAM_RG_web.pdf', sourceType: 'system_map', localFile: 'campbell-river-1' }], preservedFiles: ['campbell-river-1'], mapDate: 'September 2025', mapPageOrSection: 'system map pages and legend', evidenceNotes: 'The official Campbell River map pages were preserved and reviewed; they show routes and service information but do not name a frequent/high-frequency category or define a frequent threshold.'
  },
  'comox-valley': {
    status: 'no_definition_on_map', mapCandidates: [{ label: 'Comox Valley Rider Guide / system map', url: 'https://www.bctransit.com/comox-valley/wp-content/uploads/sites/13/2026/09/13403-13240_COM_RG_v2.pdf', sourceType: 'system_map', localFile: 'comox-valley-1' }], preservedFiles: ['comox-valley-1'], mapDate: 'September 2026', mapPageOrSection: 'system map pages and legend', evidenceNotes: 'The official Comox Valley map pages were preserved and reviewed; they show routes and service information but do not name a frequent/high-frequency category or define a frequent threshold.'
  },
  cowichan: {
    status: 'no_definition_on_map', mapCandidates: [{ label: 'Cowichan Valley Rider Guide / system map', url: 'https://www.bctransit.com/cowichan-valley/wp-content/uploads/sites/14/2026/01/cow_rg_jan2025.pdf', sourceType: 'system_map', localFile: 'cowichan-1' }], preservedFiles: ['cowichan-1'], mapDate: 'January 2026', mapPageOrSection: 'system map pages and legend', evidenceNotes: 'The official Cowichan Valley map pages were preserved and reviewed; they show routes and express services but do not name a frequent/high-frequency category or define a frequent threshold.'
  },
  'bc-fraser-valley': {
    status: 'no_definition_on_map', mapCandidates: [{ label: 'Central Fraser Valley Rider Guide / system map', url: 'https://www.bctransit.com/central-fraser-valley/wp-content/uploads/sites/9/2026/08/cfv_rg_sept2026.pdf', sourceType: 'system_map', localFile: 'bc-fraser-valley-1' }], preservedFiles: ['bc-fraser-valley-1'], mapDate: 'September 2026', mapPageOrSection: 'system map pages and legend', evidenceNotes: 'The official Central Fraser Valley map pages were preserved and reviewed; they do not name a frequent/high-frequency category or define a frequent threshold.'
  },
  kamloops: {
    status: 'no_definition_on_map', mapCandidates: [{ label: 'Kamloops Rider Guide / system map', url: 'https://www.bctransit.com/kamloops/wp-content/uploads/sites/23/2026/08/13383_KAM_RG_fall-v6.pdf', sourceType: 'system_map', localFile: 'kamloops-1' }], preservedFiles: ['kamloops-1'], mapDate: 'August 2026', mapPageOrSection: 'system map pages and legend', evidenceNotes: 'The official Kamloops map pages were preserved and reviewed; they do not name a frequent/high-frequency category or define a frequent threshold.'
  },
  kelowna: {
    status: 'numeric_definition_on_map', mapCandidates: [{ label: 'Kelowna Rider Guide / system map', url: 'https://www.bctransit.com/kelowna/wp-content/uploads/sites/24/2026/08/kel_rg_sept2026.pdf', sourceType: 'system_map', localFile: 'kelowna-1' }], preservedFiles: ['kelowna-1'], mapDate: 'September 2026', mapPageOrSection: 'system map legend', exactMapWording: 'Frequent Route — 15–30 minute service', thresholdText: '15–30 minute service', serviceSpan: 'not specified in reviewed legend', days: 'not specified in reviewed legend', geography: 'route', mode: 'bus', evidenceNotes: 'The current official Kelowna map directly labels Frequent Route and gives a 15–30-minute service range; it is retained as a range rather than flattened to one threshold.'
  },
  nanaimo: {
