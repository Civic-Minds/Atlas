  ...
  it('keeps same-headsign physical branches separate', () => {
    const trips = [
      ...Array.from({ length: 6 }, (_, i) => ({
        route_id: '14', service_id: 'weekday', trip_id: `a${i}`, trip_headsign: 'Appleby GO',
        direction_id: '0', shape_id: 'branch-a',
      })),
      ...Array.from({ length: 6 }, (_, i) => ({
        route_id: '14', service_id: 'weekday', trip_id: `b${i}`, trip_headsign: 'Appleby GO',
        direction_id: '0', shape_id: 'branch-b',
      })),
    ];
    ...
    const gtfs = {
      agencies: [],
      routes: [{ route_id: '14', route_short_name: '14', route_type: '3' }],
      trips,
      stops: [{ stop_id: 'origin', stop_name: 'Origin', stop_lat: '43', stop_lon: '-79' }],
      stopTimes,
      calendar: [{
