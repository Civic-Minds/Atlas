...
import { BWG_ON_DEMAND_AGENCY, CALEDON_ON_DEMAND_AGENCY, BRAMPTON_ON_DEMAND_AGENCY, YRT_NORTH_CENTRAL_ON_DEMAND_AGENCY } from './data/onDemandServiceAreas';
  ...
  useEffect(() => {
    ...
    fetch('/data/index.json')
      ...
      .then((data: { agencies: Agency[] }) => {
        const enriched = [...data.agencies, BWG_ON_DEMAND_AGENCY, CALEDON_ON_DEMAND_AGENCY, BRAMPTON_ON_DEMAND_AGENCY, YRT_NORTH_CENTRAL_ON_DEMAND_AGENCY]
