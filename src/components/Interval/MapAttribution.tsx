...
export function MapAttribution() {
  return (
    <div className={`absolute bottom-6 left-6 ${Z_PANEL} pointer-events-auto`}>
      <div className={`${MAP_BADGE} h-8 max-w-[min(18rem,calc(100vw-6rem))]`}>
        <p className={`${MAP_BADGE_LABEL} leading-none [&_a]:text-[var(--text-dim)] [&_a]:no-underline [&_a]:hover:text-[var(--text-primary)]`}>
          Map tiles by{' '}
