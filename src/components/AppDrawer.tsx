...
import { ArrowLeftRight, Clock, Radio, Signal } from 'lucide-react';
import { FLOATING_CARD } from '../styles';

export type AppId = 'frequency' | 'corridors' | 'history' | 'live' | 'quality';
...
const APPS: AppEntry[] = [
  ...
  },
  {
    ...
    description: 'Stop frequency across the network',
