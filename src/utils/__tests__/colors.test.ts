...
describe('getTierColor', () => {
  it('should return correct color for headway <= 10', () => {
    expect(getTierColor('10')).toBe('#10b981');
    expect(getTierColor('5')).toBe('#10b981');
  });

  it('should return correct color for headway between 10 and 15', () => {
    expect(getTierColor('15')).toBe('#6366f1');
    expect(getTierColor('11')).toBe('#6366f1');
  });

  it('should return correct color for infrequent service', () => {
    expect(getTierColor('90')).toBe('#4b5563');
  });
