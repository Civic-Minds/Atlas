      ...
      <div className="max-w-2xl mx-auto">
        ...
        <article className="mt-10 space-y-6 text-sm leading-relaxed">
          ...
          {privacy ? <>
            ...
            <section><h2 className="font-black mb-2">Analytics</h2><p>Atlas uses Cloudflare Analytics, Vercel Web Analytics, Vercel Speed Insights, and—when allowed or you choose it—Google Analytics 4 to understand site usage and performance. These services may collect page views, device type, approximate location, referrer, and performance measurements. Atlas does not use this information for advertising or account profiling. You can change your Google Analytics choice through Privacy &amp; analytics in the About panel.</p></section>
