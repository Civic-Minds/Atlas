          ...
          <footer className="mx-auto max-w-3xl border-t border-[var(--border-primary)] pt-10">
            <div className="w-full">
              ...
              <div className="mt-5 space-y-5 text-sm sm:text-base leading-7 sm:leading-8 text-[var(--text-muted)]">
                ...
                <p><strong className="text-[var(--text-primary)]">Review boundary.</strong> Only current official system maps and map legends counted as evidence. Official route pages, schedules, planning documents, and service standards were used only to locate maps and were never treated as definitions.</p>
