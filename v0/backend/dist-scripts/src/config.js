...
exports.POLL_INTERVAL_MS = exports.AGENCIES = exports.ROUTE_FILTER = void 0;
exports.agencyTimezone = agencyTimezone;
/**
...
exports.POLL_INTERVAL_MS = parseInt(process.env.POLL_INTERVAL_MS ?? '30000', 10);
/** Lookup an agency's IANA timezone string. Falls back to America/Toronto. */
function agencyTimezone(agencyId) {
    const agency = exports.AGENCIES.find(a => a.id === agencyId);
