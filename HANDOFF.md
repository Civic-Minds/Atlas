...
- Current-source research has recovered and documented 64 agencies so far, including Athens, Blacksburg, Davenport, El Monte, EMTA, Guelph, JFK AirTrain, Kenosha, North County Transit District, RTS Gainesville, Sioux Area Metro, StarMetro, and Waukesha. DC Streetcar is discontinued; Greater Glens Falls Transit was merged into CDTA.
...
2. Prepare targeted refresh commands for the 64 verified replacements, but ask separately before running them because they write to live R2.
