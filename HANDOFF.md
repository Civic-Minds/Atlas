...
- The latest read-only audit found 40 newer sources, 32 genuinely expired agencies, and 4 manual-review cases (`augusta`, `lavta`, `sfmta`, `westberkeley`).
...
1. Continue investigating the 32 genuinely expired agencies and the 4 manual-review cases; configure only validated current feeds.
