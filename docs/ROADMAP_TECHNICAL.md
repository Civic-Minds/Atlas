...
- [x] **PVR Mathematical Modeling**: Logic to calculate the Peak Vehicle Requirement (simultaneous active trips) for a given schedule, including layover and deadhead buffers.
...
- [x] **Financial Rate Registry**: Store per-agency operating rates ($/hour, $/mile) to power live budgeting.
