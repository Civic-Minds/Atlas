...
Snapshot from the expired-source audit on 2026-09-19. The audit checked 75
remaining expired production snapshots: 40 now have newer sources, 31 remain genuinely
...
The 30 agencies below remain candidates for source recovery. The read-only audit
...
| `avon-transit`, `cat-savannah`, `qline`, `sacrt`, `rockregion`, `taft`, `tillamook`, `wichita`, `xpress-ga` | A matching feed was found, but its service window ended before or at the audit date. |
...
The following 64 agencies have a current ZIP with matching agency identity and
can be refreshed using the configured or automatically derived source:

`abqride`, `arvin`, `athens-oh`, `avta`, `blacksburg`, `carson-circuit`, `carta-chattanooga`, `clemson-cat`, `davenport`, `duke`, `elmonte`, `emta`, `eugene-ltd`, `gold-coast`, `goldengate`, `goraleigh`, `grand-junction`, `indygo`, `jfk-airtrain`, `mont-tremblant`, `mountainmetro`, `rts`,
