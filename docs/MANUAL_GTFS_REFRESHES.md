...
Snapshot from the expired-source audit on 2026-09-19. The audit checked 77
remaining expired production snapshots: 40 now have newer sources, 33 remain genuinely
...
The 32 agencies below remain candidates for source recovery. The read-only audit
