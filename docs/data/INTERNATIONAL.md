...
| ilévia (Lille) | — | No `shapes.txt` in the feed at all (unrelated gap — same as CTS Strasbourg, Pont-à-Mousson, and TaM Montpellier: the agency's own export never included shape geometry, nothing to repair). **Blocked** — see [`KNOWN_ISSUES.md`](../operations/KNOWN_ISSUES.md) § Missing Agencies. | — |
...
[Back to Roadmap](../roadmap/ROADMAP.md) · [Agency Backlog](./AGENCY_BACKLOG.md) · [Research](../product/RESEARCH.md) · [Strategy](../product/STRATEGY.md)
